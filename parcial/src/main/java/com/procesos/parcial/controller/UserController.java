...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<User> createUser(@RequestBody @Valid Request<User> request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<User> updateUser(@RequestBody @Valid Request<User> request, @PathVariable @Min(1) Long id) {
