package com.procesos.parcial.config;

import com.procesos.parcial.exceptions.NotFoundException;
import com.procesos.parcial.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailService() {
        return email -> userRepository.findByEmail(email).orElseThrow(() ->
                new NotFoundException(ErrorMessage.INVALID_CREDENTIAL.getMessage()));
    }
